...
export class Relation {
	...
	/** 初期化 */
	constructor($: JQueryStatic, notebookLeft: Notebook, notebookRight: Notebook,
	...
	private html(): string {
		...
		let height = Math.max(this.notebookLeft.$view.height() || 0, this.notebookRight.$view.height() || 0);
